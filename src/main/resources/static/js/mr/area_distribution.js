...
var AreaDistribution = function() {
		// URI : /mr/count_ip.json
		this.url = null,
		this.id = "area-distribution",
			...
			$.ajax({
			    ...
			    success: function (rs) {
					...
					for(var ip in datas) {
			            ...
			            var city = IPUtil.getCityByIpAsync(ip, function(city) {
					...
					setTimeout(function() {
				        ...
				        var dailyActiveChart = echarts.init(document.getElementById(wrapper.id));
